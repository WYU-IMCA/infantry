...
def generate_launch_description():
    ...
    rune_detector_node = ComposableNode(    
        ...
        name='buff_detector',
        parameters=[get_params('buff_detector')],
        extra_arguments=[{'use_intra_process_comms': True}]
        )
    rune_solver_node = Node(
        ...
        output='both',
        emulate_tty=True,
        parameters=[get_params('buff_tracker')],
        arguments=['--ros-args',], 
        )
    #录像
    rm_auto_record_node = Node(
        ...
        output='both',
        emulate_tty=True,
        parameters=[get_params('rm_auto_record')],
    ...
    if launch_params['record']:
        launch_description_list.append(rm_auto_record_node)
